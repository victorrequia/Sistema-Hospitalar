    ...
    public PainelLogin() {
                ...
                try {
                    if (sistema.isValidAutentication(senha.getText(), login.getText())) {
                        ...
                        JOptionPane.showMessageDialog(null, "Login feito com sucesso", "Login",
                                JOptionPane.PLAIN_MESSAGE, new ImageIcon("images/check.png"));
                        painelPaciente.imagemOperacoesBloqueadas
                                .setIcon(new ImageIcon("images/cadeadoLoginAberto.png"));
                        painelMedico.imagemOperacoesBloqueadas.setIcon(new ImageIcon("images/cadeadoLoginAberto.png"));
                        painelConsulta.imagemOperacoesBloqueadas
                                .setIcon(new ImageIcon("images/cadeadoLoginAberto.png"));
                    }
                } catch (FalhaAutenticarException ex) {
                    login.setText("");
                    senha.setText("");
                    JOptionPane.showMessageDialog(null, "Usuario ou senha invalido", "Erro Autenticacao",
        ...
        botaoLogout.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                botaoLogout.setVisible(false);
                sistema.Logout();
                JOptionPane.showMessageDialog(null, "Logou feito com suceso", "Logout", JOptionPane.PLAIN_MESSAGE,
                        new ImageIcon("images/check.png"));
